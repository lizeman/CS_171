...
public class SortTester {
    ...
    final static int INSERTION = 0;
    final static int SELECTION = 1;
    final static int MERGE     = 2;
    final static int MERGE_NR  = 3;
    final static int QUICK     = 4;

    final static int NUM_TRIALS = 100;
    final static int MIN_LOG_SIZE = 2;
    final static int MAX_LOG_SIZE = 14;
        ...
        for (int p = 0; p < MAX_LOG_SIZE - MIN_LOG_SIZE; p++) {
            ...
            for (int i = 0; i < NUM_TRIALS; i++) {
                ...
                for (int j = 0; j < 5; j++) {
                    ...
                    switch(j) {
                        case INSERTION  : sorter = new InsertionSorter<Double>();  break;
                        case SELECTION  : sorter = new SelectionSorter<Double>();  break;
                        case MERGE      : sorter = new MergeSorter<Double>();      break;
                        case MERGE_NR   : sorter = new MergeSortNR<Double>();    break;
                        case QUICK      : sorter = new QuickSorter<Double>();      break;
                        default         : sorter = null;
                    }
